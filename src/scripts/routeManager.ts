...
export class Route {
    ...
    constructor(public screen: Screen, public albums: Album[], public fullscreenImage: Image | null, public tagInputFocused: boolean | null = null) {
    }
